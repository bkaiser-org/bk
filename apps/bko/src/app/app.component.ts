...
import { IonApp, IonContent, IonHeader, IonMenu, IonRouterOutlet, IonSplitPane, IonTitle, IonToolbar, Platform } from '@ionic/angular/standalone';
...
@Component({
  ...
  imports: [
    ...
    BkMenuComponent, AuthInfoComponent, 
    TranslocoModule,
    IonApp, IonSplitPane, IonMenu, IonHeader, IonTitle, 
    IonContent, IonToolbar, IonRouterOutlet
  ],
  selector: 'bk-root',
  template: `
  <!--
