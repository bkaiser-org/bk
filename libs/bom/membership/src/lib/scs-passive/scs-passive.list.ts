...
import { ScsPassiveService } from './scs-passive.service';
...
@Component({
  selector: 'bk-membership-scs-passive-list',
  styles: `
  ion-backdrop {
    opacity: 0.5;
...
export class MembershipScsPassiveListComponent extends BaseModelListComponent implements OnInit {
  public baseService = inject(ScsPassiveService);
  ...
  protected listType = ListType.MemberScsPassive;
  protected collectionName = CollectionNames.Membership;
  protected listRoute = '/membership/scsPassive';
