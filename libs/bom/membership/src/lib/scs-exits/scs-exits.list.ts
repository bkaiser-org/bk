...
import { ScsExitsService } from './scs-exits.service';

@Component({
  selector: 'bk-membership-scs-exits-list',
  styles: `
  ion-backdrop {
    opacity: 0.5;
...
export class MembershipScsExitsListComponent extends BaseModelListComponent implements OnInit {
  public baseService = inject(ScsExitsService);
  ...
  protected listType = ListType.MemberScsExits;
  protected collectionName = CollectionNames.Membership;
  protected listRoute = '/membership/scsExits';
