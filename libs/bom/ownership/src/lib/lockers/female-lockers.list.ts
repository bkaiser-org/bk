...
import { FemaleLockersService } from './female-lockers.service';
...
@Component({
  selector: 'bk-ownership-female-locker-list',
  standalone: true,
  imports: [ 
...
export class OwnershipFemaleLockerListComponent extends BaseModelListComponent implements OnInit {
  public baseService = inject(FemaleLockersService);

  public BT = BoatTypes;
  public RS = RelationshipStates;
  public FT = FilterType;
  protected listType = ListType.OwnershipFemaleLockers;
  protected collectionName = CollectionNames.Ownership;
  protected listRoute = '/ownership/femaleLockers';
