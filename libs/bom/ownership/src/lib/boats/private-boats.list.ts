      ...
      @for(_ownership of ownerships; track _ownership.bkey) {
        <ion-item-sliding #slidingItem>
          <ion-item>
            ...
            <ion-label (click)="edit(_ownership.objectKey, MT.Boat)">{{ _ownership.objectName }}</ion-label>
          </ion-item>
          @if(authorizationService.hasRole('resourceAdmin')) {
...
export class OwnershipPrivateBoatsListComponent extends BaseModelListComponent implements OnInit {
  public baseService = inject(PrivateBoatsService);
