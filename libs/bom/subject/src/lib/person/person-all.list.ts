...
export class PersonAllListComponent extends BaseModelListComponent implements OnInit {
  protected baseService = inject(PersonAllService);
  protected listType = ListType.PersonAll;
  ...
  public override async add(): Promise<void> {
    ...
    await this.baseService.navigateToUrl('/person/new');  
  }
