...
export function convertSubjectAndUserToProfileForm(subject: SubjectModel | undefined, user: UserModel | undefined): ProfileFormModel {
  if (!subject || !user) die('ProfileFormUtil.convertSubjectAndUserToProfileForm: subject and user are mandatory.');
  return {
      // subject
