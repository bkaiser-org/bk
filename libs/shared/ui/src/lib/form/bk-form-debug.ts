...
import { BkFormModel } from '@bk/models';
import { PrettyjsonPipe } from '@bk/pipes';
...
export class BkFormDebugComponent {
  ...
  protected validate(): void {
    ...
    if (_suite) {
      ...
      console.log('BkFormDebugComponent.validate: hasErrors = ' + _result.hasErrors());
